...
public class AirtableController : MonoBehaviour
{
    ...
    public void UpdatePlayerName()
    {
        ...
        updateRecordExample.RecordId = "recrkmCUXvxQ1KLvx";
    ...
    public IEnumerator LoadPlayerInfoCoroutine()
    {
        ...
        getRecordExample.RecordId = "recrkmCUXvxQ1KLvx";
    ...
    public void JSONParse()
    {
        ...
        sceneController.Age = data.fields.Age;
    ...
    public void CreateGameDataEntry()
    {
        createRecord.TableName = "Try";
        createRecord.NewRecordJson = "{\"fields\": {" +
                                    "\"Ants\":\"" + sceneController.coins + "\", " +
                                    "\"Dogs\":\"" + sceneController.timePlayed + "\", " +
                                    "\"Slugs\":\"" + sceneController.health + "\", " +
                                    "\"Rats\":\"" + sceneController.score + "\"" +
                                    "}}";
        createRecord.CreateAirtableRecord();
    }
